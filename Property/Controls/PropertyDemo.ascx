...
<script>
    ...
    $(document).ready(function () {
        $("#shareBtn").click(function () {
            ...
            var URL = 'http://gtadreamhome.ca/PropertyDetails.aspx?MLSID=' + MLSID + '&PropertyType=' + PropertyType;
                ...
                <div class="col-md-4 col-sm-4">
                    ...
                    <div class="roco_pro_info">
                        ...
                        <h2 style="font-size: 19px !important">
                            <asp:Label ID="lblname" runat="server"></asp:Label>Jesse Virdi & Sam Sharma</h2>
                        <p>Sales Representative </p>
                        <asp:Label CssClass="email_profile_r" ID="lblemail" runat="server"></asp:Label>
                         <span class="email_profile_r">647-688-2009 , 1-800-538-9514</span>
